...
$content = str_replace('</title>','</title><base href="High-fidelity prototypes" />', $content);
$content = str_replace('</head>','<link rel="stylesheet" href="css/hello.css" /></head>', $content);
echo $content;
